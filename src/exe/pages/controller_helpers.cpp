...
// ---- Grid view — simplified, no inner cards ------------------------------
...
bool draw_player_panel(const char* name,
    ...
    HANDLE_BIND("FN1",   fn1,   cm::BindingTarget::FN1,   bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    HANDLE_BIND("Start", start, cm::BindingTarget::Start, bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    HANDLE_BIND("FN2",   fn2,   cm::BindingTarget::FN2,   bind_target, cooldown_until_ms, now_ms);
    ...
    // Directions
    ut::cardTitle("DIRECTIONS");
    ImGui::Indent(72.0f);
    HANDLE_BIND("Up",   up,   cm::BindingTarget::Up,   bind_target, cooldown_until_ms, now_ms);
    ImGui::Unindent(72.0f);
    HANDLE_BIND("Left", left, cm::BindingTarget::Left, bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    ImGui::Dummy(ImVec2(kBindButtonW, 0));
    ImGui::SameLine(0, 8);
    HANDLE_BIND("Right", right, cm::BindingTarget::Right, bind_target, cooldown_until_ms, now_ms);
    ImGui::Indent(72.0f);
    HANDLE_BIND("Down", down, cm::BindingTarget::Down, bind_target, cooldown_until_ms, now_ms);
    ImGui::Unindent(72.0f);
    ...
    // Buttons
    ut::cardTitle("BUTTONS");
    HANDLE_BIND("A",   a,   cm::BindingTarget::A,   bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    HANDLE_BIND("B",   b,   cm::BindingTarget::B,   bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    HANDLE_BIND("C",   c,   cm::BindingTarget::C,   bind_target, cooldown_until_ms, now_ms);
    ImGui::Spacing();
    HANDLE_BIND("D",   d,   cm::BindingTarget::D,   bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    HANDLE_BIND("E",   e,   cm::BindingTarget::E,   bind_target, cooldown_until_ms, now_ms);
    ImGui::SameLine(0, 8);
    HANDLE_BIND("A+B", ab,  cm::BindingTarget::AB,  bind_target, cooldown_until_ms, now_ms);
